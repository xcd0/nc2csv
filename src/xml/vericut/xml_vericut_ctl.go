...
func getElement(r rune, label *[]string) []rune {
	// <があったら次の>までを一旦保存する
	for i = i + 1; i < len(rx); i++ {
		var t []rune
		for i = i + 1; i < len(rx); i++ {
			r := rx[i]
			if r == '>' {
...
func getAttribute() {
	// <があったら次の空白か>までを要素名として保存する
	var rs []rune
	// 1字づつ > まで読む
exit_element:
	for i = i + 1; i < len(rx); i++ { // for文の中でもiが増やされる
		r = rx[i]
		switch r {
		case '>':
			// 要素の読み込み終わり
			label = append(label, string(rs))
			break exit_element
		case ' ':
			// 属性が来た
			label = append(label, string(rs)) // 現時点での要素名を保存
			...
			for j := 0; j < len(a); j++ {
				...
				if ra == '=' {
					// 要素.属性 の形式で保存
					label = append(label, string(rs)+"_"+string(rs2))
					ra = '>'
					// 次の空白まで捨てる
					// >は含まれてないので最後まで来たら自動で抜ける
					for j = j + 1; j < len(a); j++ {
						ra = a[j]
						if ra == ' ' {
							break
...
func getAncestor(ancestor []string) string {
	out := ""
...
func main() {
	...
	/*
		...
		////
		1. </が出るまで'<*** 'をlabelに保存。
			1. 保存の仕方はトップのみlabel = elemで、
			それ以外label = append( label, getAncestor(ancestor) + "." + elem )
			1. 保存するたびにancestorにも追加する ancestor = append(ancestor, elem)
		2. </が出たら>まで捨て、ancestorを減らす
			1. ancestor = ancestor[:len(ancestor)-1]
	*/
	...
	for i := 0; i < len(rx); i++ {
		...
		// <>の中身だけ保存する
		if r == '<' && rx[i+1] != '?' && rx[i+1] != '/' {
			tmp1 = getElement(r, label)
			// tmp1には<の中身>
			// tmp1について解析する
			tmp2 = getAttribute(tmp2, label)
		}
...
<VcControl Version="8.2" Unit="inch">
  ...
  <Words>
    <Word Name="#" Type="variable_tag"></Word>
    <Word Name="$" Type="skip"></Word>
    <Word Name="$$" Type="skip"></Word>
    <Word Name="%" Type="skip"></Word>
    <Word Name="(" Type="begin_comment"></Word>
    <Word Name=")" Type="end_comment"></Word>
    <Word Name="*" Type="multiplication"></Word>
    <Word Name="+" Type="addition"></Word>
    <Word Name="," Type="separator"></Word>
    <Word Name=",C" Type="macro_call">
      <Value Type="numeric" InchType="decimal" InchFormat="3.4" MetricType="decimal" MetricFormat="4.3" Multiply="off" Multiplier="1"/></Word>
    <Word Name=",R" Type="macro_call">
      <Value Type="numeric" InchType="decimal" InchFormat="3.4" MetricType="decimal" MetricFormat="4.3" Multiply="off" Multiplier="1"/></Word>
    <Word Name="-" Type="subtraction"></Word>
    <Word Name="/" Type="conditional">
      ...
      <Function Name="AtanCondDivide"/></Word>
    <Word Name=":" Type="macro_call">
      <Value Type="numeric" InchType="decimal" InchFormat="4.0" MetricType="decimal" MetricFormat="4.0" Multiply="off" Multiplier="1"/></Word>
    <Word Name="&lt;" Type="macro_call">
      <Value Type="alpha_numeric"/></Word>
    <Word Name="&lt;&lt;" Type="concatenate"></Word>
    <Word Name="=" Type="assignment"></Word>
    <Word Name="&gt;" Type="macro_call">
      <Value Type="none"/></Word>
    <Word Name="[" Type="left_precedence"></Word>
    <Word Name="\N" Type="end_block"></Word>
    <Word Name="]" Type="right_precedence"></Word>
    <Word Name="^" Type="power"></Word>
    <Word Name="A" Type="macro_call">
      <Value Type="numeric" InchType="decimal" InchFormat="3.4" MetricType="decimal" MetricFormat="3.4" Multiply="off" Multiplier="1"/></Word>
    <Word Name="ABS" Type="function_call">
      <Function Name="abs" Type="normal"/></Word>
    <Word Name="ACOS" Type="function_call">
      <Function Name="acos_d" Type="normal"/></Word>
    <Word Name="AND" Type="bitwise_and"></Word>
    <Word Name="ASIN" Type="function_call">
      <Function Name="asin_d" Type="normal"/></Word>
    <Word Name="ATAN" Type="function_call">
      <Function Name="atan2_d" Type="normal"/></Word>
    ...
    <Word Name="COS" Type="function_call">
      <Function Name="cos_d" Type="normal"/></Word>
    <Word Name="D" Type="macro_call">
      <Value Type="numeric" InchType="decimal" InchFormat="3.0" MetricType="decimal" MetricFormat="3.0" Multiply="off" Multiplier="1"/></Word>
    <Word Name="DEFINE" Type="S840D_define"></Word>
    <Word Name="DO" Type="macro_call">
      <Value Type="numeric" InchType="decimal" InchFormat="" MetricType="decimal" MetricFormat="" Multiply="off" Multiplier="1"/></Word>
    <Word Name="DOORS" Type="macro_call">
      <Value Type="none"/></Word>
    <Word Name="DPRNT" Type="macro_call">
      <Value Type="text_string"/></Word>
    <Word Name="E" Type="macro_call">
      <Value Type="numeric" InchType="decimal" InchFormat="" MetricType="decimal" MetricFormat="" Multiply="off" Multiplier="1"/></Word>
    <Word Name="END" Type="macro_call">
      <Value Type="numeric" InchType="decimal" InchFormat="" MetricType="decimal" MetricFormat="" Multiply="off" Multiplier="1"/></Word>
    <Word Name="EQ" Type="equal"></Word>
    <Word Name="EXP" Type="function_call">
      <Function Name="exp" Type="normal"/></Word>
    <Word Name="F" Type="macro_call">
      <Value Type="numeric" InchType="decimal" InchFormat="3.4" MetricType="decimal" MetricFormat="4.5" Multiply="off" Multiplier="1"/></Word>
    <Word Name="FIX" Type="function_call">
      <Function Name="IntTruncAdj" Type="normal"/></Word>
    <Word Name="FUP" Type="function_call">
      <Function Name="AbsCeil" Type="normal"/></Word>
    <Word Name="G" Type="macro_call">
      <Value Type="numeric" InchType="decimal" InchFormat="2.1" MetricType="decimal" MetricFormat="2.1" Multiply="off" Multiplier="1"/></Word>
    <Word Name="GE" Type="greater_equal"></Word>
    <Word Name="GOTO" Type="macro_call">
      <Value Type="numeric" InchType="decimal" InchFormat="" MetricType="decimal" MetricFormat="" Multiply="off" Multiplier="1"/></Word>
    <Word Name="GT" Type="greater_than"></Word>
    <Word Name="H" Type="macro_call">
      <Value Type="numeric" InchType="decimal" InchFormat="3.3" MetricType="decimal" MetricFormat="3.3" Multiply="off" Multiplier="1"/></Word>
    <Word Name="I" Type="macro_call">
      <Value Type="numeric" InchType="decimal" InchFormat="3.8" MetricType="decimal" MetricFormat="4.8" Multiply="off" Multiplier="1"/></Word>
    ...
    <Word Name="L" Type="macro_call">
      <Value Type="numeric" InchType="decimal" InchFormat="4.0" MetricType="decimal" MetricFormat="4.0" Multiply="off" Multiplier="1"/></Word>
    <Word Name="LE" Type="less_equal"></Word>
    <Word Name="LENGTH" Type="function_call">
      <Function Name="STRLEN" Type="normal"/></Word>
    <Word Name="LN" Type="function_call">
      <Function Name="ln" Type="normal"/></Word>
    <Word Name="LT" Type="less_than"></Word>
    <Word Name="M" Type="macro_call">
      <Value Type="numeric" InchType="decimal" InchFormat="3.0" MetricType="decimal" MetricFormat="3.0" Multiply="off" Multiplier="1"/></Word>
    <Word Name="MP03403" Type="variable_name"></Word>
    <Word Name="MP_03403" Type="variable_name"></Word>
    <Word Name="N" Type="macro_call">
      <Value Type="numeric" InchType="decimal" InchFormat="4.0" MetricType="decimal" MetricFormat="4.0" Multiply="off" Multiplier="1"/></Word>
    <Word Name="NE" Type="not_equal"></Word>
    <Word Name="NUMBER" Type="function_call">
      <Function Name="NUMBER" Type="normal"/></Word>
    <Word Name="O" Type="macro_call">
      <Value Type="numeric" InchType="decimal" InchFormat="4.0" MetricType="decimal" MetricFormat="4.0" Multiply="off" Multiplier="1"/></Word>
    <Word Name="OPEN" Type="macro_call">
      <Value Type="none"/></Word>
    <Word Name="OR" Type="bitwise_or"></Word>
    <Word Name="P" Type="macro_call">
      <Value Type="numeric" InchType="decimal" InchFormat="4.4" MetricType="decimal" MetricFormat="4.3" Multiply="off" Multiplier="1"/></Word>
    ...
    <Word Name="RND" Type="function_call">
      <Function Name="Round" Type="normal"/></Word>
    <Word Name="ROUND" Type="function_call">
      <Function Name="Round" Type="normal"/></Word>
    <Word Name="S" Type="macro_call">
      <Value Type="numeric" InchType="decimal" InchFormat="" MetricType="decimal" MetricFormat="" Multiply="off" Multiplier="1"/></Word>
    <Word Name="SETVN" Type="Fan_setvn"></Word>
    <Word Name="SIN" Type="function_call">
      <Function Name="sin_d" Type="normal"/></Word>
    <Word Name="SQRT" Type="function_call">
      <Function Name="sqrt" Type="normal"/></Word>
    <Word Name="SUBSTR" Type="function_call">
      <Function Name="SUBSTR" Type="normal"/></Word>
    <Word Name="T" Type="macro_call">
      <Value Type="numeric" InchType="decimal" InchFormat="2.0" MetricType="decimal" MetricFormat="2.0" Multiply="off" Multiplier="1"/></Word>
    <Word Name="TAN" Type="function_call">
      <Function Name="tan_d" Type="normal"/></Word>
    <Word Name="THEN" Type="ignore"></Word>
    ...
    <Word Name="X" Type="macro_call">
      <Value Type="numeric" InchType="decimal" InchFormat="3.4" MetricType="decimal" MetricFormat="5.4" Multiply="on" Multiplier="1"/></Word>
    <Word Name="XOR" Type="bitwise_xor"></Word>
    <Word Name="Y" Type="macro_call">
      <Value Type="numeric" InchType="decimal" InchFormat="3.4" MetricType="decimal" MetricFormat="5.4" Multiply="off" Multiplier="1"/></Word>
  ...
  <SuperGroup Name="Specials">
    <Group Name="G" Type="word" Description="Manual Guide i Probing Cycles" Range="2020-2040" Field="0">
      <ConditionMacro>
        <Variable Name="4010" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4210" Scan="no" AfterMotion="no"></Variable>
    ...
    <Group Name="N" Type="word" Description="Sequence number" Field="0">
      <ConditionMacro>
        <Variable Name="4114" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4314" Scan="no" AfterMotion="no"></Variable>
    ...
    <Group Name="O" Type="word" Description="Subroutine Sequence number" Field="0">
      <ConditionMacro>
        <Variable Name="4115" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4315" Scan="no" AfterMotion="no"></Variable>
  ...
  <SuperGroup Name="States">
    ...
    <Group Name="G" Type="word" Description="NC macro call continuous with motion" Range="66" Field="0">
      <ConditionMacro>
        <Variable Name="4012" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4212" Scan="no" AfterMotion="no"></Variable>
        <Macro Name="MacroVarState2" Scan="no" AfterMotion="no">
    ...
    <Group Name="G" Type="word" Description="Rapid positioning" Range="0" Field="0">
      <ConditionMacro>
        <Variable Name="4001" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4201" Scan="no" AfterMotion="no"></Variable>
    ...
    <Group Name="G" Type="word" Description="Polar interpolation on" Range="12.1 112" Field="0">
      <ConditionMacro>
        <Variable Name="4021" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4221" Scan="no" AfterMotion="no"></Variable>
    ...
    <Group Name="G" Type="word" Description="Polar coordinates command cancel" Range="15" Field="0">
      <ConditionMacro>
        <Variable Name="4017" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4217" Scan="no" AfterMotion="no"></Variable>
    ...
    <Group Name="G" Type="word" Description="XY plane select" Range="17" Field="0">
      <ConditionMacro>
        <Variable Name="4002" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4202" Scan="no" AfterMotion="no"></Variable>
    ...
    <Group Name="G" Type="word" Description="Inch input" Range="20" Field="0">
      <ConditionMacro>
        <Variable Name="4006" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4206" Scan="no" AfterMotion="no"></Variable>
    ...
    <Group Name="G" Type="word" Description="Spindle speed fluctuation detection/ off" Range="25 26" Field="0">
      <ConditionMacro>
        <Variable Name="4019" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4219" Scan="no" AfterMotion="no"></Variable>
        <Macro Name="IgnoreMacro" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
    </Group>
    <Group Name="G" Type="word" Description="Probe" Range="31" Field="0">
      <ConditionMacro>
        ...
        <Variable Name="5061" Scan="no" AfterMotion="yes">
          <Override  Type="expression"  Value="#5041"  Units="0"/></Variable>
        <Variable Name="5062" Scan="no" AfterMotion="yes">
          <Override  Type="expression"  Value="#5042"  Units="0"/></Variable>
        <Variable Name="5063" Scan="no" AfterMotion="yes">
          <Override  Type="expression"  Value="#5043"  Units="0"/></Variable>
        <Variable Name="5064" Scan="no" AfterMotion="yes">
          <Override  Type="expression"  Value="#5044"  Units="0"/></Variable>
        <Variable Name="5065" Scan="no" AfterMotion="yes">
          <Override  Type="expression"  Value="#5045"  Units="0"/></Variable>
        <Variable Name="5066" Scan="no" AfterMotion="yes">
          <Override  Type="expression"  Value="#5046"  Units="0"/></Variable>
        <Variable Name="5067" Scan="no" AfterMotion="yes">
          <Override  Type="expression"  Value="#5047"  Units="0"/></Variable>
        <Variable Name="5068" Scan="no" AfterMotion="yes">
          <Override  Type="expression"  Value="#5048"  Units="0"/></Variable>
        <Variable Name="5069" Scan="no" AfterMotion="yes">
          <Override  Type="expression"  Value="#5049"  Units="0"/></Variable>
      </ConditionMacro>
    </Group>
    ...
    <Group Name="G" Type="word" Description="Tool length compensation positive " Range="43" Field="0">
      <ConditionMacro>
        ...
        <Variable Name="4008" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4208" Scan="no" AfterMotion="no"></Variable>
    ...
    <Group Name="G" Type="word" Description="Mirror cancel" Range="50.1" Field="0">
      <ConditionMacro>
        <Variable Name="4022" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4222" Scan="no" AfterMotion="no"></Variable>
    ...
    <Group Name="G" Type="word" Description="Exact stop mode" Range="61" Field="0">
      <ConditionMacro>
        <Variable Name="4015" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4215" Scan="no" AfterMotion="no"></Variable>
        <Macro Name="IgnoreMacro" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
    </Group>
    ...
    <Group Name="G" Type="word" Description="Absolute command" Range="90" Field="0">
      <ConditionMacro>
        <Variable Name="4003" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4203" Scan="no" AfterMotion="no"></Variable>
    ...
    <Group Name="G" Type="word" Description="Inverse time feed" Range="93" Field="0">
      <ConditionMacro>
        <Variable Name="4005" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4205" Scan="no" AfterMotion="no"></Variable>
    ...
    <Group Name="G" Type="word" Description="Constant surface speed cancel" Range="97" Field="0">
      <ConditionMacro>
        <Variable Name="4013" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4213" Scan="no" AfterMotion="no"></Variable>
  ...
  <SuperGroup Name="Cycles">
    ...
    <Group Name="G" Type="word" Description="Drilling cycle, deep" Range="73" Field="0">
      <ConditionMacro>
        <Variable Name="4009" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4209" Scan="no" AfterMotion="no"></Variable>
  ...
  <SuperGroup Name="Registers">
    <Group Name="A" Type="word" Description="" Field="0">
      ...
      <ConditionMacro>
        ...
        <Variable Name="107118" Scan="no" AfterMotion="no"></Variable>
    ...
    <Group Name="B" Type="word" Description="" Field="0">
      ...
      <ConditionMacro>
        <Variable Name="4102" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4302" Scan="no" AfterMotion="no"></Variable>
    ...
    <Group Name="D" Type="word" Description="" Field="0">
      ...
      <ConditionMacro>
        <Variable Name="4107" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4307" Scan="no" AfterMotion="no"></Variable>
    ...
    <Group Name="F" Type="word" Description="" Field="0">
      <ConditionMacro>
        <Variable Name="4109" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4309" Scan="no" AfterMotion="no"></Variable>
    ...
    <Group Name="H" Type="word" Description="" Field="0">
      ...
      <ConditionMacro>
        <Variable Name="4111" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4311" Scan="no" AfterMotion="no"></Variable>
    ...
    <Group Name="I" Type="word" Description="" Field="0">
      ...
      <ConditionMacro>
        ...
        <Variable Name="CGT_G51_SCALE_FACTOR_X" Scan="no" AfterMotion="no"></Variable>
      </ConditionMacro>
      <ConditionMacro>
    ...
    <Group Name="P" Type="word" Description="" Field="0">
      <ConditionMacro>
        ...
        <Variable Name="3001" Scan="no" AfterMotion="no">
          <Override  Type="expression"  Value="#3001 + $"  Units="0"/></Variable>
      </ConditionMacro>
      <ConditionMacro>
      ...
      <ConditionMacro>
        ...
        <Variable Name="CGT_G51_SCALE_FACTOR" Scan="no" AfterMotion="no">
          <Override  Type="expression"  Value="$/1000"  Units="0"/></Variable>
        <Macro Name="RotationPlaneXScale" Scan="no" AfterMotion="no">
      ...
      <ConditionMacro>
        ...
        <Variable Name="4014" Scan="no" AfterMotion="no"></Variable>
        <Macro Name="WorkCoordIndex" Scan="no" AfterMotion="no">
        </Macro>
        <Macro Name="TableSubRegisterValue" Scan="no" AfterMotion="no">
          <Override  Type="value"  Value="1"  Units="0"/>
      ...
      <ConditionMacro>
        ...
        <Variable Name="4130" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4330" Scan="no" AfterMotion="no"></Variable>
        <Macro Name="WorkCoordIndex" Scan="no" AfterMotion="no">
        </Macro>
        <Macro Name="TableSubRegisterValue" Scan="no" AfterMotion="no">
          <Override  Type="value"  Value="2"  Units="0"/>
      ...
      <ConditionMacro>
        ...
        <Variable Name="5500" Scan="no" AfterMotion="no"></Variable>
      </ConditionMacro>
      <ConditionMacro>
        <CondWord Logical="and" Name="G" Range="54.2"/>
        <Variable Name="5500" Scan="no" AfterMotion="no"></Variable>
      ...
      <ConditionMacro>
        <CondWord Logical="and" Name="G" Range="54.4"/>
        <CondWord Logical="and" Name="P" Range="0"/>
        <Variable Name="CGT_G54.4_PNO" Scan="no" AfterMotion="no"></Variable>
        <Macro Name="DynamicWorkOffsets" Scan="no" AfterMotion="no">
          <Override  Type="value"  Value="0"  Units="0"/>
        </Macro>
      ...
      <ConditionMacro>
        <CondWord Logical="and" Name="G" Range="68.2"/>
        <Variable Name="CGT_G68.2_P" Scan="no" AfterMotion="no"></Variable>
      </ConditionMacro>
      <ConditionMacro>
        <CondWord Logical="and" Name="M" Range="98"/>
        <Macro Name="SubroutineName" Scan="no" AfterMotion="no">
      ...
      <ConditionMacro>
        ...
        <Variable Name="100016" Scan="no" AfterMotion="no"></Variable>
      </ConditionMacro>
      <ConditionMacro>
        <CondWord Logical="and" Name="M" Range="198"/>
        <Macro Name="SubroutineName" Scan="no" AfterMotion="no">
    ...
    <Group Name="S" Type="word" Description="" Field="0">
      ...
      <ConditionMacro>
        <Variable Name="4119" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4319" Scan="no" AfterMotion="no"></Variable>
    ...
    <Group Name="T" Type="word" Description="" Field="0">
      <ConditionMacro>
        <Variable Name="4120" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4320" Scan="no" AfterMotion="no"></Variable>
  ...
  <SuperGroup Name="G_Prep">
    ...
    <Group Name="G" Type="word" Description="Reference point return" Range="28" Field="0">
      <ConditionMacro>
        <Variable Name="4008" Scan="no" AfterMotion="no">
          <Override  Type="value"  Value="49"  Units="0"/></Variable>
    ...
    <Group Name="G" Type="word" Description="Cutter/3D tool compensation cancel" Range="40" Field="0">
      <ConditionMacro>
        <Variable Name="4007" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4207" Scan="no" AfterMotion="no"></Variable>
    ...
    <Group Name="G" Type="word" Description="Scaling OFF" Range="50" Field="0">
      <ConditionMacro>
        <Variable Name="4011" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4021" Scan="no" AfterMotion="no"></Variable>
    ...
    <Group Name="G" Type="word" Description="Additional work offset coordinate system " Range="54" Field="0">
      ...
      <ConditionMacro>
        <CondWord Logical="and" Name="P"/>
        <Variable Name="4014" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4214" Scan="no" AfterMotion="no"></Variable>
        <Macro Name="TableSubRegisterValue" Scan="no" AfterMotion="no">
          <Override  Type="value"  Value="1"  Units="0"/>
        </Macro>
    ...
    <Group Name="G" Type="word" Description="Dynamic work offset coordinate system " Range="54.2" Field="0">
      <ConditionMacro>
        <Variable Name="4023" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4223" Scan="no" AfterMotion="no"></Variable>
        <Macro Name="SecondaryWorkCoord" Scan="no" AfterMotion="no">
          <Override  Type="text"  Value="ERROR"/>
        </Macro>
      </ConditionMacro>
    ...
    <Group Name="G" Type="word" Description="Workpiece setting error compensation" Range="54.4" Field="0">
      <ConditionMacro>
        <CondWord Logical="and" Name="P" Range="1-7"/>
        <Variable Name="4033" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4233" Scan="no" AfterMotion="no"></Variable>
        <Macro Name="SecondaryWorkCoord" Scan="no" AfterMotion="no">
          <Override  Type="text"  Value="ERROR"/>
        </Macro>
      </ConditionMacro>
      ...
      <ConditionMacro>
        ...
        <Variable Name="4033" Scan="no" AfterMotion="no">
          <Override  Type="value"  Value="0"  Units="0"/></Variable>
    ...
    <Group Name="G" Type="word" Description="Coordinate system rotation / 3D Coordinate system rotation" Range="68" Field="0">
      <ConditionMacro>
        <CondWord Logical="and" Name="I"/>
        <Variable Name="4016" Scan="no" AfterMotion="no"></Variable>
        <Variable Name="4216" Scan="no" AfterMotion="no"></Variable>
